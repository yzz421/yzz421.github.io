...
- slide
  ...
  - slide 转移基本都靠 **#提前准备** 的 U 盘，需要保证有冗余的备份文件的 U 盘 (**#缺失**)、保证讲师更改 slide 后能确实重新放到 U 盘，重新放到要播放的笔记本上了
  ...
  U 盘内和每个播放的 笔记本内，还需要有大会的宣传背景图 (**#缺失**)，在没有开场之前一直保持背景是宣传图，而不是黑屏 (E 会场)
...
- LED 大屏(尺寸确认)、舞台、背景墙、门口导航牌 等实地搭建相关大型物品设备
- 会场平面示意图，手册内、现场导航牌
